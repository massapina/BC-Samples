...
<html>
	<head>
		<meta charset="UTF-8">
		<title>BAM Checkout Mobile Web Scanner Demo</title>	
		...
		<script type="text/javascript">
			document.addEventListener('ns.submit', function yourEventListener(yourEvent) {
				...
				var cardSecurityCode = typeof(yourEvent.detail.cardSecurityCode) == "undefined" ? '' : yourEvent.detail.cardSecurityCode;
	...
	<body data-ng-app="nshtml5sdk">
		<header>
			<h1><img src="img/logo.png" alt="BAM Checkout Mobile Web">BAM Checkout Mobile Web Scanner Demo</h1>
		</header>
		<div data-ns-card-scanner="<?php echo TokenGenerator::generateToken(); ?>" data-public-identifier="<?php echo TokenGenerator::getPublicIdentifier(); ?>" ></div>
	</body>
</html>